...
const CRITERIA = {
  ...
  'rsi-oversold': {
    label: 'RSI超卖',
    check(r, o) { return r.analysis.rsi.rsi6 != null && r.analysis.rsi.rsi6 < (o.rsiLevel != null ? o.rsiLevel : 30); },
  },
  'rsi-overbought': {
    label: 'RSI超买',
    check(r, o) { return r.analysis.rsi.rsi6 != null && r.analysis.rsi.rsi6 > (o.rsiLevel != null ? o.rsiLevel : 70); },
  },
  'kdj-golden': {
    label: 'KDJ金叉',
...
async function runScan(ctx, cache, items, criterionNames, opts = {}) {
  ...
  for (let idx = 0; idx < items.length; idx++) {
    ...
    try {
      ...
      const score = scoreBars(bars, { analysis, patterns });
