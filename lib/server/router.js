...
function isAllowedOrigin(origin) {
  ...
  // 允许任意 10jqka.com.cn 子域（www/stockpage/news/data...）
  return /^https?:\/\/(?:[a-z0-9-]+\.)*10jqka\.com\.cn(?::\d+)?$/i.test(origin);
}
